# -*- coding: utf-8 -*-
"""
Django settings for riceshare project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'riceshare.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'riceshare.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'riceshare.users.adapters.SocialAccountAdapter'
