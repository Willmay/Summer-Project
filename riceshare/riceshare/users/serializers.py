...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = (
            'username', 'email', 'password', 'name', 'photo', 'location', 'background', 'home',
            'short_description', 'saved_users', 'id')
...
class ProfileReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = (
            'username', 'name', 'photo', 'location', 'background', 'home', 'short_description',
            'saved_users', 'id', 'pk')
